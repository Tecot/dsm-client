      ...
      <div class="srp-search-conditions-container">
        ...
        <div class="search-condition-container">
          ...
          <div class="known-checked">
            <el-checkbox v-model="searchContent.includeUnknownDepth">Does it contain unknown?</el-checkbox>
          </div>
        </div>
        ...
        <div class="search-condition-container">
          ...
          <div class="known-checked">
            <el-checkbox v-model="searchContent.includeUnknownll">Does it contain unknown?</el-checkbox>
          </div>
        </div>
